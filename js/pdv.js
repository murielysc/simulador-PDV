...
function adicionarProduto(id) {
    ...
    //recarregar o cupom e recalcular os totais
    carregarCupom();
    atualizarTotais();
}
...
/*---------função para calcular total de desconto---------*/
...
/*----------Função para remover produto do cupom---------*/

function removerProduto(id) {
    //Remover o produto do cupom
    cupom = cupom.filter(p => p.id != id);

    //Recarregar o cupom e atualiza os totais
    carregarCupom();
    atualizarTotais();
}